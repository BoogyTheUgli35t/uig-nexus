...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "UIG is a multi-division, AI-first group building the next generation of infrastructure for Africa and the world." },
      { name: "author", content: "Unified Innovations Group" },
      { property: "og:title", content: "Unified Innovations Group" },
      { property: "og:description", content: "AI-first, multi-division group: Technology, AgriTech, Real Estate, Logistics, Intelligence and Innovation Lab." },
