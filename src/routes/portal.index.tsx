  ...
  head: () => ({
    meta: [
      { title: "UIG Apex Portal — Secure Workspace for UIG Clients & Teams" },
      {
        name: "description",
        content:
          "Apex is the unified portal for UIG clients, partners and internal teams — projects, documents, tasks and intelligence in one place.",
      },
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        title={
          <>
            The UIG <span className="text-gradient-gold">Apex Portal.</span>
          </>
        }
      ...
      <Section>
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          <FeatureCard
            ...
            description="KPIs, project status and AI-powered insights at a glance."
          />
          <FeatureCard
            icon={<FolderKanban className="h-5 w-5" />}
            title="Universal projects"
            description="Tech builds, properties and shipments all in one project model."
          />
          <FeatureCard
            icon={<Users className="h-5 w-5" />}
            title="Roles & organizations"
            description="Admin, staff and client roles with strict, org-scoped access."
          />
          <FeatureCard
            icon={<Shield className="h-5 w-5" />}
            title="Enterprise-grade security"
            description="Row-level security, encrypted storage and full audit trails."
          />
        </div>
      </Section>
    </SiteLayout>
