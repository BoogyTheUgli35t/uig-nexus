      ...
      <DataPanel
        ...
        action={
          <Link
            ...
            className="inline-flex items-center gap-1 text-sm acc-text hover:underline"
          >
      ...
      >
        {isLoading ? (
          ...
          <EmptyState
            icon={Cpu}
            title="No models yet"
            description="Create your first model from the Models tab."
          />
        ) : (
      ...
      >
        {(data?.predictions.length ?? 0) === 0 ? (
          <EmptyState
            ...
            description="Run a live prediction from the Assistant tab."
          />
        ) : (
