  ...
  head: () => ({
    meta: [
      { title: "About UIG — Our Story, Mission and Vision" },
      {
        name: "description",
        content:
          "Unified Innovations Group is an AI-native, multi-division group operating across technology, agriculture, real estate, logistics and venture innovation.",
      },
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        title={
          <>
            One group. <span className="text-gradient-gold">Six divisions.</span> A unified vision.
          </>
        }
      ...
      <Section>
        <div className="grid gap-12 lg:grid-cols-3">
          <div className="lg:col-span-2 space-y-6 text-muted-foreground leading-relaxed">
            ...
            <p>
              UIG was founded with a single conviction: the next decade of African enterprise will
              be defined by groups that combine deep operational expertise with AI-native systems.
              So we built one.
            </p>
            <p>
              From day one, we designed UIG as a multi-division group — each division focused on a
              real, hard sector, and each division powered by the same shared spine of AI, data and
              engineering capability.
            </p>
            <p>
              The result is a company where a model trained for logistics improves real estate
              decisions, where a portal built for one client becomes infrastructure for an industry,
              and where every division compounds the strength of the others.
            </p>
          </div>
          <div className="space-y-6">
            <div className="rounded-xl border border-gold/20 bg-surface p-6">
              ...
              <p className="mt-3 text-foreground leading-relaxed">
                To build and operate AI-native systems that move African industries — and the global
                economy — forward.
              </p>
            </div>
            <div className="rounded-xl border border-gold/20 bg-surface p-6">
      ...
      <Section>
        ...
        <p className="mt-4 text-muted-foreground max-w-3xl">
          Each division is independently focused but operationally unified. Shared AI, shared data,
          shared design, shared portal — Apex — to coordinate everything.
        </p>
        <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {[
            [
              "Shared AI spine",
              "UIG Intelligence trains and serves models for every other division.",
            ],
            [
              "Shared portal",
              "Apex is the single client and operations interface across divisions.",
            ],
            [
              "Shared data",
              "Cross-division insights compound — agriculture meets logistics meets finance.",
            ],
      ...
      <CTABand
        title="Want to work with UIG?"
        subtitle="Tell us about your sector, your problem, or your idea."
      />
    </SiteLayout>
  );
}
